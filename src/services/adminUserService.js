...
export const configureCollectiveBrainPublicAccess = callable('configureCollectiveBrainPublicAccess');
export const getPublicCollectiveBrainBoard = callable('getPublicCollectiveBrainBoard');
export const submitPublicCollectiveBrainResponse = callable('submitPublicCollectiveBrainResponse');
