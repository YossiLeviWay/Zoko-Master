...
export const executeZokiAttendance = callable('executeZokiAttendance');
export const executeZokiCalendarEvent = callable('executeZokiCalendarEvent');
export const executeZokiCalendarEventUpdate = callable('executeZokiCalendarEventUpdate');
export const executeZokiCalendarEventCancel = callable('executeZokiCalendarEventCancel');
export const executeZokiContact = callable('executeZokiContact');
export const executeZokiDirectPermission = callable('executeZokiDirectPermission');
...
export const executeZokiRoleAssignment = callable('executeZokiRoleAssignment');
export const executeZokiResourceAccess = callable('executeZokiResourceAccess');
export const executeZokiResourceCreate = callable('executeZokiResourceCreate');
export const executeZokiResourceMove = callable('executeZokiResourceMove');
export const executeZokiTaskStatus = callable('executeZokiTaskStatus');
export const executeZokiTaskAssignment = callable('executeZokiTaskAssignment');
export const executeZokiTaskDetails = callable('executeZokiTaskDetails');
export const executeZokiResourceRename = callable('executeZokiResourceRename');
export const executeZokiStudentTrack = callable('executeZokiStudentTrack');
export const executeZokiStudentNote = callable('executeZokiStudentNote');
export const executeZokiTeamMembership = callable('executeZokiTeamMembership');
export const executeZokiTeamCreate = callable('executeZokiTeamCreate');
export const executeZokiTeamManager = callable('executeZokiTeamManager');
